...
/**
 * @author 小陈
 * @time 2018/1/25  14:35
 * @desc 分区推荐全区动态section
 */
public class RegionRecommendDynamicSection extends StatelessSection{
    ...
    public RegionRecommendDynamicSection(Context context, List<RegionRecommendInfo.DataBean.DynamicBean>dynamicBeans) {
