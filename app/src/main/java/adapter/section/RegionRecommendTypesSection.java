...
public class RegionRecommendTypesSection extends StatelessSection{
    ...
    private int[] danceIcons = new int[] {
            R.drawable.ic_category_t20, R.drawable.ic_category_t154,
            R.drawable.ic_category_t156
    };
    ...
    //科技类型titles
    private String[] scienceTitles = new String[] { "纪录片", "趣味科普人文", "野生技术协会", "演讲·公开课", "星海", "数码",
            "机械" };
    ...
    private int[] entertainmentIcons = new int[] {
            R.drawable.ic_category_t71, R.drawable.ic_category_t137,
            R.drawable.ic_category_t131
    };
