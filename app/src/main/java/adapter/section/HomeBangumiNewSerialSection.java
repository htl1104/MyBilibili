...
import module.home.NewBangumiSerialActivity;
import utils.NumberUtil;
import widget.sectioned.StatelessSection;

/**
 * @author 小陈
 * @time 2018/1/19  16:46
 * @desc 首页番剧新番连载Section
 */
public class HomeBangumiNewSerialSection extends StatelessSection {
    ...
    public HomeBangumiNewSerialSection(Context context,List<BangumiAppIndexInfo.ResultBean.SerializingBean> newBangumiSerials) {
        super(R.layout.layout_home_bangumi_new_serial_head,
                R.layout.layout_home_bangumi_new_serial_body);
