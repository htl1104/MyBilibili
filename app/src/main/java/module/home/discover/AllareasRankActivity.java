...
public class AllareasRankActivity extends BaseActivity{
    ...
    public void initViews(Bundle savedInstanceState) {
        ...
        if(bundle!=null) {
           position=bundle.getInt(ConstantUtil.EXTRA_POSITION); 
        }
        initViewPager();
    }

    private void initViewPager() {
        AllareasRankPagerAdapter adapter=new AllareasRankPagerAdapter(getSupportFragmentManager(),titles,types);
