...
import adapter.VideoRelatedAdapter;
...
public class VideoIntroductionFragment extends RxLazyFragment {
    ...
    protected void finishTask() {
        ...
        mAuthorTagView.setUpWithInfo(getActivity(),
                mVideoDetailsInfo.getOwner().getName(),
                mVideoDetailsInfo.getOwner().getMid(),
                mVideoDetailsInfo.getOwner().getFace());
        //设置分享 收藏 投币数量
